...
import { Plus, Briefcase, ChevronRight, Target } from 'lucide-react';
    ...
    <div className="p-8 max-w-3xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="border border-dashed border-neutral-700 rounded-xl p-14 text-center">
          ...
          <p className="text-gray-300 font-medium mb-1">No offers yet</p>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5 font-mono">{offer.slug}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <Link
                  ...
                  className="hidden group-hover:flex items-center gap-1.5 text-xs text-gray-400 hover:text-white px-3 py-1.5 rounded-lg border border-neutral-700 hover:border-neutral-500 transition-all"
                >
